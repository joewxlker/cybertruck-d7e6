        ...
        <form className="flex-1 flex flex-col gap-5 justify-evenly">
            <div className='flex flex-row justify-between items-center w-full'>
                ...
                <div className="group relative rounded-full justify-center items-center cursor-pointer xl:flex lg:flex hidden">
                    ...
                    <div className='absolute opacity-0 group-hover:opacity-100 left-[50%] -top-[100px] p-1 -translate-x-[50%] bg-black bg-opacity-90 w-96 transition-all duration-300'>
                        <p className="text-white font-body">
                            A 50/50 chance at doubling or losing your bet amount. RNG is generated by the blockchain, all results are transparant on etherscan.
                        </p>
                    </div>
                </div>
            </div>
